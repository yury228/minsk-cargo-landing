...
const faqData = [
  {
    ...
    answer:
      'Стоимость перевозки зависит от объёма груза, расстояния и сложности работ. Мы предлагаем бесплатную оценку стоимости при выезде специалиста. Минимальная стоимость перевозки от 70 рублей.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Мы выполняем квартирные и офисные переезды, перевозку мебели, бытовой техники, строительных материалов, доставку товаров, перевозку оборудования и другие виды грузоперевозок по Минску, всей Беларуси и направлениям в Россию (РФ).',
  },
  {
